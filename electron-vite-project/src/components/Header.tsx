    ...
    <div className='header'>
      <div className='containerHeader'>
        <ul className="unorderedList">
          <li>
            <Link to="/Studio" className={location.pathname === '/' || location.pathname === '/Studio' ? 'is-active' : ''}>
