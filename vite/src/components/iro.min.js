  ...
  function S(n, i, t, r, e, u, o, l, s) {
    ...
    if (
      ...
      (i.n = A(i.n, function (t) {
        if (null != t) {
          if (((t.i = i), (t.e = i.e + 1), null === (f = b[c]) || (f && t.key == f.key && t.type === f.type)))
            b[c] = void 0;
          else
            for (a = 0; a < p; a++) {
      ...
      t: if ('function' == typeof k) {
        if (
          ...
          null != k.getDerivedStateFromProps &&
            M(f.j == f.state ? (f.j = M({}, f.j)) : f.j, k.getDerivedStateFromProps(p, f.j)),
          h)
        )
      ...
      (t.prototype.render = function (t, e) {
        ...
        return (
          Array.isArray(n) ||
            ...
            e.transparency && n.push({ component: pt, options: { sliderType: 'alpha' } })),
          h(
            'div',
            ...
            n.map(function (t, n) {
              ...
              return h(
                i,
                Object.assign({}, e, r, { ref: void 0, onInput: u.emitInputEvent.bind(u), parent: u, index: n })
              );
            })
          )
        );
